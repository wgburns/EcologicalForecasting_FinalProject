...
# Here i combine all the bay data
...
data = multmerge("/Users/chege/Desktop/quantitative reasoning final project/st.albans")
...
without_bloom_numeric <- without_bloom_indicator %>%
  ...
  select(-c(date,X,TempMean, TurbMean, DeltaDOMean, bay, year, ChlMean)) %>% # Here i have removed Ph and timestamp
...
ggsave("stalbans_0_days_lag.png")
...
xgb.plot.importance(importance)
ggsave("stalbans_1_days_lag.png")
...
xgb.plot.importance(importance)
ggsave("stalbans_2_days_lag.png")
...
xgb.plot.importance(importance)
ggsave("stalbans_3_days_lag.png")
...
xgb.plot.importance(importance)
ggsave("stalbans_4_days_lag.png")
...
xgb.plot.importance(importance)
ggsave("stalbans_5_days_lag.png")
...
xgb.plot.importance(importance)
ggsave("stalbans_6_days_lag.png")
