...
>>>>>>> dddc3940efdb8033c1ce526386022e45938a069e


results_2 <- read.csv("allCombined.csv") 
...
results_1 <- read.csv("Sep_bay_and_year.csv") 
...
results_3 <- read.csv("Sep_bay.csv") 
...
results_4 <- read.csv("Sep_year.csv") 
