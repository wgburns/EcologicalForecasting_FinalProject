...
Second, we could correlate the buoys' measure of PC levels with other indicators of bloom presence such as satellite data and volunteer observations of bloom presence or absence. There is satellite imagery available covering both bays, and it can be used to calculate a spectral index that's indicative of cyanobacteria presence. We could calculate this index for the position of each buoy at each time point with available satellite imagery
