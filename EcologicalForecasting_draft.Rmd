...
- 6 days out, pH is IMPORTANT for PC but the next step is figuring out if it's PREDICTIVE of a bloom. 
- We should include chlorophyll because for predictive models it's important 

- IMPORTANT POINT: there is a difference between mechanistic models and predictive models and if we were just looking at   
