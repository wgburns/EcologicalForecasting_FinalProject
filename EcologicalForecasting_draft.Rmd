...
```{r, echo = F, message = F, warning= FALSE, fig.cap= "Feature importance with all  bays and years combined. Discharge, Solar Radiation, and Specific Conductivity were the most important features for explaining contemporaneous PC levels, while Air Temperature, Solar Radiation and Wind Speed were most important for future PC levels. Year was an important feature, while Bay was not."}
...
results_2 %>% 
  ...
  scale_fill_brewer(palette = "Paired", labels = c("Stratification", "Discharge", "Solar radiation", "Specific conductivity", "Air temperature", "Wind direction", "Wind speed", "Year")) +
  xlab("Days in the Future") +
  labs(title = "Feature Importance for Combined Bays & Years") +
  #expand = c(0,0)) +
  theme_bw() +
  theme(
...
results_1 %>% 
  ...
  scale_y_continuous(limits = c(0, 1.01),
                     name = "Feature Importance") + 
  scale_fill_brewer(palette = "Paired", labels = c("Stratification", "Discharge", "Solar radiation", "Specific conductivity", "Air temperature", "Wind direction", "Wind speed"))+
  xlab("Days in the future")+
    labs(title = "Feature Importance for each Bay & Year") +
  #expand = c(0,0))+
  theme_bw()+
  theme(
        axis.title = element_text(size = 12),
...
results_3 %>% 
  ...
  scale_fill_brewer(palette = "Paired", labels = c("Stratification", "Discharge", "Solar radiation", "Specific conductivity", "Air temperature", "Wind direction", "Wind speed", "Year"))+
  xlab("Days in the future")+
  labs(title = "Feature Importance for each Bay (Years Combined)") +
  #expand = c(0,0))+
  theme_bw()+
  theme(
        axis.title = element_text(size = 12),
...
results_4 %>% 
  ...
  scale_fill_brewer(palette = "Paired", labels = c("Stratification", "Discharge", "Solar radiation", "Specific conductivity", "Air temperature", "Wind direction", "Wind speed"))+
  xlab("Days in the future")+
  labs(title = "Feature Importance for each Year (Bays Combined)") +
  #expand = c(0,0))+
  theme_bw()+
  theme(
        axis.title = element_text(size = 12),
