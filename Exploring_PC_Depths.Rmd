...
```
PC levels are highly correlated for all depths. More so than in 2017.
...
chart.Correlation(SA17_depths[,2:6], histogram = T)
```
PC levels are highly correlated for all depths.
...
chart.Correlation(SA18_depths[,2:6], histogram = T)
```
PC levels are very highly correlated for all depths! 
